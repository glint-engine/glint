...
export class Vector2 implements BasicVector2 {
    ...
    add(other: BasicVector2): Vector2;
    ...
    sub(other: BasicVector2): Vector2;
    ...
    angle(other: BasicVector2): number;
    ...
    lineAngle(end: BasicVector2): number;
    ...
    mul(other: BasicVector2): Vector2;
    ...
    div(other: BasicVector2): Vector2;
    ...
    moveTowards(target: BasicVector2, maxDistance: number): Vector2;
    ...
    clamp(min: BasicVector2, max: BasicVector2): Vector2;
    ...
    equals(other: BasicVector2): number;
    ...
    refract(n: BasicVector2, r: number): Vector2;
